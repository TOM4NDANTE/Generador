...
if [ ${Debian_version} == 9 ];then
    wget -N --no-check-certificate https://github.com/lacasitadelterror/V2ray.Fun/blob/master/enable-debian9-rclocal.sh
...
#Install V2ray.Fun
cd /usr/local/
git clone https://github.com/lacasitadelterror/V2ray.Fun
